...
export default function BlogDetails() {
    ...
    return (
      <div className="flex flex-col gap-10">
        {sections.map((section, index) => {
          ...
          if (index === 0 && !title.includes("؟")) {
            return (
              <p
                key={index}
                className="text-base sm:text-lg text-gray-300 leading-loose text-right"
              >
                {section.trim()}
              </p>
            );
          ...
          return (
            <div key={index} id={`section-${index}`} className="space-y-3">
              <div className="flex items-center gap-3 text-right">
                <i
                  className={`fa-solid ${
                    title.includes("الخلاصة") ? "fa-lightbulb" : "fa-star"
              ...
              <p className="text-base sm:text-lg text-gray-300 leading-loose text-right">
                {body}
              </p>
            </div>
          );
  ...
  function TableOfContents({ content }) {
    ...
    return (
      <div className="sticky top-24 w-80 shrink-0">
        <div className="p-6 bg-[#111111] border border-white/20 rounded-2xl">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 bg-proj/10 border border-proj rounded-lg flex items-center justify-center">
              <i className="fa-solid fa-bars text-proj text-sm"></i>
            </div>
            <span className="text-lg font-bold text-white">محتويات المقال</span>
          </div>
          ...
          <nav className="flex flex-col gap-1">
            {sections.map((title, index) => (
              <button
                ...
                className="group flex items-start gap-2 p-3 rounded-lg hover:bg-proj/10 transition"
              >
                <i className="fa-solid fa-chevron-left text-xs text-proj mt-1 group-hover:translate-x-1 transition-transform"></i>
                <span className="text-sm text-gray-300 group-hover:text-white leading-relaxed">
                  {title}
                </span>
              </button>
            ))}
        ...
        <div className="p-6 flex flex-col sm:flex-row gap-3 bg-[#111111] border border-white/20 rounded-2xl mt-3">
          <div className="p-4 flex flex-col gap-2 sm:w-1/2 items-center w-full bg-black rounded-2xl border border-white/20">
            <i className="fa-regular fa-calendar text-proj text-xl"></i>
            <span className="font-bold text-white">{post.date}</span>
            <span className="text-xs text-gray-500">تاريخ النشر</span>
          </div>

          <div className="p-4 flex flex-col gap-2 items-center sm:w-1/2 w-full bg-black rounded-2xl border border-white/20">
            <i className="fa-regular fa-clock text-proj text-xl"></i>
            <span className="font-bold text-white text-center">{post.readTime}</span>
  ...
  return (
    <section className="relative">
      <div
        className="w-full bg-center bg-cover relative min-h-[60vh] lg:min-h-[80vh]"
      ...
      >
        ...
        <div className="relative z-10">
          <div className="p-4 sm:p-8 flex items-center">
            <div className="bg-black/50 rounded-full border border-white/20 flex gap-2 px-4 py-2 items-center">
              <Link
                to="/"
                className="fa-solid fa-house text-gray-300 text-sm"
              />
              <i className="fa-solid fa-chevron-left text-gray-400 text-sm"></i>
              <Link to="/blog" className="text-gray-300 text-sm">
                المدونة
              </Link>
              <i className="fa-solid fa-chevron-left text-gray-400 text-sm"></i>
              <span className="text-proj text-sm">{post.category}</span>
            </div>
          </div>

          <div className="px-4 sm:px-8 lg:px-40 pb-14 flex flex-col gap-6 text-right">
            <div className="flex flex-wrap gap-4 items-center">
              <span className="px-4 py-2 bg-orange-400 rounded-full text-sm font-bold text-white">
                {post.category}
              </span>
              <span className="flex gap-2 items-center text-gray-200 text-sm">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white max-w-3xl leading-tight">
              {post.title}
            </h1>

            <div className="p-4 border-2 w-fit border-proj/50 bg-black/80 rounded-2xl inline-flex items-center gap-3">
              <img
                src={post.author.avatar}
                className="w-14 h-14 rounded-full border border-proj"
                alt=""
              />
              <div>
        ...
        <div className="max-w-7xl mx-auto pt-16 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="flex-1">
              <div className="p-6 bg-proj/20 border border-proj/70 rounded-2xl mb-8">
                <p className="text-white/90 leading-relaxed">{post.excerpt}</p>
              </div>

              {renderContent(post.content)}

              <div className="p-6 bg-[#111111] border border-white/20 rounded-2xl mt-10">
                <div className="flex gap-3 items-center mb-4">
                  <i className="fa-solid fa-tags text-proj"></i>
                ...
                <div className="flex flex-wrap gap-2">
                  {post.tags.map((tag, i) => (
                    <span
                      key={i}
                      className="px-3 py-2 text-sm border border-white/20 rounded-full text-gray-400 hover:text-proj hover:border-proj transition"
                    >
                      {tag}
                    </span>
                  ))}

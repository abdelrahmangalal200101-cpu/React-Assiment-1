...
export default function House() {
  ...
  const featuredPosts = blogPosts.posts
    .filter((post) => post.featured)
    .slice(0, 3);
  const newestPosts = [...blogPosts.posts]
  ...
  return (
    <>
      <Header></Header>
      <Articles posts={featuredPosts}></Articles>
      <Explore categories={blogPosts.categories}></Explore>
      <Newest posts={newestPosts}></Newest>
      <Subs></Subs>
    </>
  );
}
